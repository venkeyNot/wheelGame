...
db.gamePlay = require("./gameplays.js")(sequelize, Sequelize);
db.gamePosition = require("./gameposition.js")(sequelize, Sequelize);
db.walletHistory = require("./wallethistory.js")(sequelize, Sequelize);
